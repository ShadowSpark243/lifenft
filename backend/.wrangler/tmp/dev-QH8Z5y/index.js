...
// .wrangler/tmp/bundle-RnpsXE/checked-fetch.js
...
var logout = /* @__PURE__ */ __name(async (c) => {
  const { userId } = await c.req.json();
  if (!userId) return c.json({ message: "User ID is required!" }, 400);
  return c.json({ message: "\u2705 Logout Successful" });
}, "logout");
var getUserProfile = /* @__PURE__ */ __name(async (c) => {
...
var DonationService = class {
  static {
    __name(this, "DonationService");
  }
  constructor(db) {
    this.db = db;
  }
...
var createDonation = /* @__PURE__ */ __name(async (c) => {
...
var verifyDonation = /* @__PURE__ */ __name(async (c) => {
...
var mintNFT = /* @__PURE__ */ __name(async (c) => {
  const donationId = c.req.param("id");
...
var requireHospital = /* @__PURE__ */ __name(async (c, next) => {
...
var donationRoutes_default = donationRoutes;
...
app.route("/donations", donationRoutes_default);
var src_default = app;
...
// .wrangler/tmp/bundle-RnpsXE/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-RnpsXE/middleware-loader.entry.ts
